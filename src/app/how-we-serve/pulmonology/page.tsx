          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <p className="text-gray-700 text-lg mb-6 max-w-xl text-justify">
                Remote Patient Monitoring (RPM) programs can be seamlessly customized to 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-700 text-lg leading-relaxed text-justify">
                ...
                professional clinical monitoring services are built to support your 
                practice goals and enhance the quality of patient care.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-[#012c66] mb-4">Pulmonology</h3>
              <p className="text-gray-700 text-lg leading-relaxed text-justify">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-white rounded-4xl shadow-2xl p-12 text-center">
            ...
            <p className="text-gray-800 text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
              Remote healthcare solutions are essential for driving efficiency and improving outcomes in 
              modern specialty care. An advanced RPM platform can transform how your practice manages 
