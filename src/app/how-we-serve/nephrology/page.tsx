    ...
    <div className="relative min-h-screen bg-gradient-to-br from-white via-white to-purple-50">
      ...
      <section className="relative h-[90vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/assets/nephrology-hero-bg.png"
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          <Image
            src="/assets/nephrology-rpm-image.png"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <Image
                  src="/assets/nephrology-feature-image.png"
                  alt={feature.title}
                  width={200}
                  height={100}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, idx) => (
              ...
              >
                <Image
                  src="/assets/nephrology-benefit-image.png"
                  alt={benefit.title}
                  width={200}
                  height={100}
                  className="mx-auto mb-4 rounded-md"
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            ...
            <Image
              src="/assets/nephrology-benefit-overview.png"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <Image
                src="/assets/nephrology-case-study1.png"
                alt="CKD Case Study"
                width={400}
                height={200}
                className="mx-auto mb-4 rounded-md"
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <Image
                src="/assets/nephrology-case-study2.png"
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          <Image
            src="/assets/nephrology-implementation-image.png"
