...
const GeriatricsPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-white via-white to-purple-50">
      {/* SEO Meta Tags */}
      <Head>
        <title>eVitals - Advanced Remote Patient Monitoring for Geriatrics</title>
        <meta
          name="description"
          content="eVitals empowers geriatricians with an advanced remote patient monitoring platform for elderly patients with chronic conditions, featuring FDA-approved devices, HIPAA-compliant security, and robust reimbursement support."
        />
        <meta
          name="keywords"
          content="remote patient monitoring, geriatrics, elderly care, chronic condition management, telehealth, FDA-approved devices, HIPAA-compliant, reimbursement support"
        />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <link rel="canonical" href="https://www.evitals.com/how-we-serve/geriatrics" />
          ...
          {`
            {
              ...
              "description": "eVitals provides an advanced remote patient monitoring platform with FDA-approved devices, HIPAA-compliant data security, and reimbursement support for geriatrics practices.",
        ...
        <div className="relative z-10 w-full text-left pl-6 md:pl-12 lg:pl-20 max-w-4xl">
          ...
          >
            <h1 className="text-white text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">
              Advanced <span className="text-[#B187E8]">Geriatrics</span> Monitoring
            </h1>
            <p className="text-white text-base md:text-lg mb-4 max-w-3xl">
              eVitals transforms geriatric care with a cutting-edge remote patient monitoring (RPM) platform for elderly patients with chronic conditions. Our FDA-approved devices deliver real-time vital sign and mobility data, enabling proactive care.
            </p>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            ...
            <p className="text-lg text-gray-800 mb-4">
              Our system integrates with FDA-approved devices and wearables, providing geriatricians with real-time data and trend analysis. This reduces complications by 35% and improves patient quality of life by 50%. Patients benefit from home-based care and fewer disruptions.
            </p>
            <p className="text-lg text-gray-800 mb-8">
              RPM supports medication adherence through automated reminders and educational content, critical for managing complex regimens in elderly patients. Our HIPAA-compliant platform ensures data security, while EHR integration streamlines workflows for busy practices.
            </p>
          </div>
          <Image
          ...
          <div className="max-w-4xl mx-auto">
            <h3 className="text-2xl font-semibold text-purple-900 mb-4">Why Geriatrics Benefits from RPM</h3>
            <p className="text-lg text-gray-800 mb-4">
              Elderly patients require vigilant monitoring to manage chronic conditions and prevent falls. eVitals’ RPM platform captures real-world data, enabling personalized care plans. For patients with heart failure or diabetes, continuous monitoring detects early signs of deterioration, preventing hospitalizations.
            </p>
            <p className="text-lg text-gray-800 mb-8">
              For mobility-impaired patients, our platform tracks activity levels and fall risks, supporting proactive management. The analytics dashboard offers insights into long-term trends, helping geriatricians optimize care. Clinical studies show a 30% reduction in complications with RPM.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-purple-900 mb-8 text-center">
            How eVitals Supports Geriatrics
          </h2>
          <p className="text-lg text-gray-800 mb-8 max-w-3xl mx-auto text-center">
            eVitals provides a robust RPM platform tailored to geriatrics, combining advanced technology, patient engagement, and reimbursement support.
          </p>
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-800 mb-4">
              eVitals offers trend analysis for long-term monitoring of chronic conditions, critical for geriatric care. Integration with wearables like smartwatches provides additional data on mobility and sleep patterns.
            </p>
            <p className="text-lg text-gray-800 mb-8">
              Our platform includes 24/7 technical support and staff training, ensuring seamless adoption. Customizable reports support clinical research, enabling geriatricians to contribute to advancements in elderly care.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-purple-900 mb-8 text-center">
            Benefits for Geriatricians and Patients
          </h2>
          <p className="text-lg text-gray-800 mb-8 max-w-3xl mx-auto text-center">
            eVitals delivers measurable benefits, improving clinical outcomes, practice efficiency, and patient satisfaction for geriatrics practices.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-800 mb-4">
              Elderly patients require ongoing monitoring to manage chronic conditions and prevent complications. eVitals’ RPM platform empowers patients to stay independent at home, improving quality of life and reducing stress.
            </p>
            <p className="text-lg text-gray-800 mb-8">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-purple-900 mb-8 text-center">
            Real-World Impact: Geriatrics Case Studies
          </h2>
          <p className="text-lg text-gray-800 mb-8 max-w-3xl mx-auto text-center">
            Discover how eVitals has transformed geriatrics practices and improved patient outcomes.
          </p>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <Image
                ...
                className="mx-auto mb-4 rounded-md"
              />
              <h3 className="text-xl font-semibold text-purple-900 mb-2">Chronic Condition Management</h3>
              <p className="text-gray-700 mb-4">
                A New York geriatrics practice implemented eVitals for 200 patients with chronic conditions. Real-time monitoring reduced complications by 40%, with 50% fewer emergency visits. Patients reported a 55% improvement in quality of life.
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <Image
                ...
                className="mx-auto mb-4 rounded-md"
              />
              <h3 className="text-xl font-semibold text-purple-900 mb-2">Fall Prevention</h3>
              <p className="text-gray-700 mb-4">
                A Florida clinic used eVitals to monitor 150 elderly patients for fall risks. Real-time tracking reduced falls by 30%. Caregivers accessed data via the portal, improving support.
              </p>
              <p className="text-gray-700">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                Our team evaluates your practice’s needs and patient demographics to customize the RPM solution for elderly patients with chronic conditions.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md">
      ...
      <section className="relative py-20 min-h-[600px] flex justify-center items-center text-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center max-w-4xl mx-auto">
          ...
          <p className="text-lg text-white mb-4 text-shadow-sm">
            Over 250 geriatrics practices rely on eVitals for secure, reliable remote monitoring. Our platform has monitored over 5,000 patients, reducing complications by 35% and improving satisfaction by 40%.
          </p>
          <p className="text-lg text-white mb-6 text-shadow-sm">
            From solo practices to large clinics, eVitals is praised for its intuitive design and comprehensive support. Join the revolution in geriatric care with a trusted platform.
          </p>
          <Link
            href="/contact"
          ...
          >
            Discover How We Serve Geriatrics →
          </Link>
        </div>
      </section>
      ...
      <section className="py-16 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-purple-900 mb-6">
            Transform Geriatrics Care with eVitals
          </h2>
          <p className="text-lg text-gray-800 mb-4 max-w-3xl mx-auto">
            Elevate your geriatrics practice with eVitals’ advanced RPM platform. Improve patient outcomes, streamline operations, and boost revenue with a solution designed for elderly care.
          </p>
          <p className="text-lg text-gray-800 mb-8 max-w-3xl mx-auto">
            Our team is ready to customize the platform to your practice’s needs, with comprehensive training and support. Schedule a personalized demo today to experience the future of geriatrics care.
          </p>
          <Link
            href="/contact"
            className="bg-[#36036B] hover:bg-[#4b0d8d] text-white text-base font-semibold px-6 py-3 rounded-md shadow-md transition duration-300 inline-block"
