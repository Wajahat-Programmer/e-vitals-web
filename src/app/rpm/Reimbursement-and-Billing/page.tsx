          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-8">
              {/* <Link
                ...
                aria-describedby="billing-report-desc"
              >
              ...
              <span id="billing-report-desc" className="sr-only">
                View an example billing report generated by the RPM software.
              </span>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl p-4 md:p-6 lg:p-8 shadow-lg border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  <div className="text-sm text-green-700 font-medium">Annualized (×12)</div>
      ...
      <section className="py-8 md:py-10 lg:py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#012c66] mb-3">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-start">
            ...
            <div className="space-y-0">
              ...
              {/* <div className="bg-[#b79cb8] p-4 border-b-2 border-white">  */}
              {/* <div className="bg-[#b79cb8] p-4 border-b-2 border-white opacity-65"> */}
              <div className="bg-[#b79cb8dd]/55 p-4 border-b-2 border-white">
                <div className="flex items-start gap-2">
                  <span className="text-black font-bold">•</span>
                  <div>
                    <p className="text-black font-bold">99454</p>
                    {/* <p className="text-blue-700 font-bold">Device Supply</p> */}
                    <p className="text-[#012c66] font-bold">Device Supply</p>
              ...
              <div className="bg-[#b79cb8dd]/55 p-4 border-b-2 border-white">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[#012c66] font-bold">Additional Time</p>
              ...
              <div className="bg-[#aaaaaa]/55 p-4 border-b-2 border-white">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[#012c66] font-bold">Physiologic Data</p>
