              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Call our support line at +1 (800) 123-4567</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">Prefer email?</h3>
                    <p className="text-gray-600">Send us a message at support@evitals.com</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <form className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full flex justify-center py-3 px-6 border border-transparent rounded-lg shadow-sm text-lg font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-300"
                  >
                    Send Message
                  </button>
                </div>
