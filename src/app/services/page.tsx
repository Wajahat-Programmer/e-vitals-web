...
import { Stethoscope, Pill, Phone, Brain, Handshake, BarChart3 } from 'lucide-react';

const ServicesPage = () => {
  const serviceIcons = [
    { icon: <Stethoscope className="w-8 h-8 text-purple-900" />, title: "Remote Patient Monitoring", description: "Track vitals 24/7 and catch problems before they become emergencies." },
    { icon: <Pill className="w-8 h-8 text-purple-900" />, title: "Chronic Care Management", description: "Coordinate long-term care plans for better outcomes." },
    { icon: <Phone className="w-8 h-8 text-purple-900" />, title: "Telehealth Consultations", description: "Connect with patients anytime, anywhere — securely and easily." },
    { icon: <Brain className="w-8 h-8 text-purple-900" />, title: "Behavioral Health", description: "Support your patients' mental health with integrated counseling." },
    { icon: <Handshake className="w-8 h-8 text-purple-900" />, title: "Care Coordination", description: "Stay connected with all care providers for seamless treatment." },
    { icon: <BarChart3 className="w-8 h-8 text-purple-900" />, title: "Analytics & Reporting", description: "Get actionable insights from clean, organized patient data." },
  ];
      ...
      <>
        ...
        <section className="mb-20 mt-12 px-4">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-purple-900 mb-4">How We Help You</h2>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10 grid gap-6">
              {[
                ...
                <div key={index} className="flex items-start text-left">
                  <svg className="w-6 h-6 text-purple-700 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="mb-20 px-4">
          <h2 className="text-3xl font-bold text-purple-900 mb-12 text-center">Complete Care Solutions</h2>
