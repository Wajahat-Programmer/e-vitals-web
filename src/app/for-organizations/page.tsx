...
const ForOrganizations = () => {
  const features = [
    {
      ...
      description: "Comprehensive remote monitoring for your entire patient population",
      icon: (
        <svg className="w-12 h-12 text-[#B187E8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const testimonials = [
    {
      quote: "e-Vitals transformed our remote patient monitoring program, reducing readmissions by 40% while improving patient satisfaction.",
      author: "Dr. Sarah Johnson",
      role: "Chief Medical Officer, HealthSystem Inc."
    },
    {
      quote: "The analytics dashboard gives us real-time insights we never had before, helping us make data-driven decisions.",
      author: "Michael Chen",
    ...
    <main className="bg-white text-gray-800">
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-6">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight text-white mb-6">
              Enterprise <span className="text-purple-300">Health Solutions</span>
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
              Transform patient outcomes with our comprehensive remote monitoring platform designed for healthcare organizations
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2E1065] mb-6">
              Designed for <span className="text-[#B187E8]">Healthcare Organizations</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-center text-gray-800 mb-4">{feature.title}</h3>
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className="flex items-baseline justify-center mb-2">
                  <span className="text-5xl font-bold text-[#2E1065] mr-2">{stat.value}</span>
                  <span className="text-2xl text-[#B187E8]">{stat.trend}</span>
                </div>
                <p className="text-lg text-center text-gray-700">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6 sm:px-12 lg:px-24 bg-[#F9F5FF]">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2E1065] mb-6">
              Trusted by <span className="text-[#B187E8]">Healthcare Leaders</span>
            </h2>
            <div className="w-24 h-1 bg-[#B187E8] mx-auto mb-6"></div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <svg className="w-8 h-8 text-[#B187E8] mb-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <p className="font-semibold text-[#2E1065]">{testimonial.author}</p>
        ...
        <section className="relative text-center px-4 mb-20 py-16 bg-gradient-to-br from-purple-100 via-purple-200 to-purple-100 rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-gray-800 mb-8 max-w-3xl mx-auto">
              Schedule a consultation with our enterprise solutions team today
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
<Link href="/contact">
  <Button
