...
const testimonials = [
  {
    quote: "eVitals has completely transformed our patient monitoring. The intuitive interface reduced our training time by 60% and improved data accuracy significantly.",
    name: "Dr. Monica Delgado",
    title: "Chief of Cardiology, Mayo Clinic",
    image: "/assets/testimonials/a1.jpg"
  },
  {
    quote: "Since implementing eVitals, our nursing staff reports 45% fewer documentation errors. The automated alerts have helped us catch critical changes much earlier.",
    name: "Sarah Kensington",
    title: "Nursing Director, Johns Hopkins",
    image: "/assets/testimonials/g1.jpg"
  },
  {
    quote: "The integration with our existing EHR was seamless. We've seen a 30% improvement in clinical workflow efficiency since going live with eVitals.",
    name: "Robert Langford",
    title: "CIO, Massachusetts General",
    image: "/assets/testimonials/a2.jpg"
  },
  {
    quote: "Our patient satisfaction scores improved by 22 points after implementing eVitals. Families appreciate the real-time monitoring transparency.",
    name: "Jennifer Morales",
    title: "Patient Experience Officer",
    image: "/assets/testimonials/a3.jpg"
  },
  {
    quote: "As a rural hospital with limited IT staff, we needed a solution that just works. eVitals delivered with zero downtime in the first 6 months.",
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        {/* Hospital Banner */}
        <div className="relative rounded-2xl overflow-hidden mb-20 max-w-6xl mx-auto h-[400px]">
          {/* Background Image */}
          <Image
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-10 p-12 text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-white mb-6 drop-shadow-md">
              You'll find us in more than 600 U.S hospitals too
            </h3>
            <button className="px-6 py-3 bg-white text-[#411C6B] font-medium rounded-lg hover:bg-gray-100 transition-colors">
              Learn More
            </button>
          </div>
        </div>
