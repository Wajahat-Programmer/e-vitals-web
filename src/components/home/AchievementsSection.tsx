  ...
  return (
    <>
      ...
      <div className="w-full overflow-hidden leading-none -mb-1">
        <svg viewBox="0 0 1440 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-10 md:h-16">
          ...
          <div className="mt-8 flex justify-center">
            <Link href="/about" passHref>
              <Button
                ...
                className="bg-gradient-to-r from-purple-700 via-indigo-700 to-fuchsia-700 text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:from-purple-800 hover:to-fuchsia-800 transition-all duration-200"
              />
            </Link>
          </div>
